      ...
      $( function() {
        // CUSTOME  METHODOLOGY
        $('.recent-work_content .time-inner').click(function(){
          $('.time-inner').removeClass('expands');
          $(this).addClass('expands');
        });

        // CUSTOME TAB CIRCLE FOR SECTION EXPERTISES  
        function tabFunction() {
            if($(window).width() > 992) {
                ...
                // run when less than 992
                // console.log('Code to run when less than') 
            }
        } 
