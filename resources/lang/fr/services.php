...
return [
    ...
    'web_graphic_design_content' => "Un site ou une application ne doivent pas proposer uniquement une expérience visuelle mais aussi un moment d’interactions réussies avec l’utilisateur. Un mix adéquat entre le créatif et le marketing.",
    'development_websites_heading' => "Développement Site Web",
    'development_websites_content' => "Que ce soit pour un site vitrine, une solution de vente en ligne, un catalogue ou du Branding. Nous vous accompagnons au mieux pour vous doter d'un site internet répondant à vos exigences et à celles de votre marché.",
    'digital_strategy_heading' => "Stratégie Digitale",
