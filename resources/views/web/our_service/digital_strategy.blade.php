        ...
        <div class="section-full-vh bg-service-detail">
            <div class="container-fluid">
                <div class="detail-ctn">
                    <h2 class="title-detail">{{ __('digital_strategy.title_detail') }}</h2>
                    <div class="detail-card">
                        <a class="btn-back" href=""><i class="lnr lnr-cross"></i></a>
                        <h3 class="text-heading">{{ __('digital_strategy.heading') }}</h3>
                        <div class="text-lead">
                            <p>{{ __('digital_strategy.text_lead') }}</p>
                        </div>
                        <div class="text-body">
                            <p>{!! __('digital_strategy.content') !!}</p>
                        </div>
                    </div>
                </div>
            </div>
