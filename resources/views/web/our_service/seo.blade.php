        ...
        <div class="section-full-vh bg-service-detail">
            <div class="container-fluid">
                <div class="detail-ctn">
                    <h2 class="title-detail">{{ __('service_seo.title_detail') }}</h2>
                    <div class="detail-card">
                        <a class="btn-back" href=""><i class="lnr lnr-cross"></i></a>
                        <h3 class="text-heading">{{ __('service_seo.heading') }}</h3>
                        <div class="text-lead">
                            <p>{{ __('service_seo.text_lead') }}</p>
                        </div>
                        <div class="text-body">
                            <p>{!! __('service_seo.content') !!}</p>
                        </div>
                    </div>
                </div>
            </div>
