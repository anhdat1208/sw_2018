        ...
        <div class="section-full-vh bg-service-detail">
            <div class="container-fluid">
                <div class="detail-ctn">
                    <h2 class="title-detail">{{ __('dedicated_team.title_detail') }}</h2>
                    <div class="detail-card">
                        <a class="btn-back" href=""><i class="lnr lnr-cross"></i></a>
                        <h3 class="text-heading">{{ __('dedicated_team.heading') }}</h3>
                        <div class="text-lead">
                            <p>{{ __('dedicated_team.text_lead') }}</p>
                        </div>
                        <div class="text-body">
                            <p>{!! __('dedicated_team.content') !!}</p>
                        </div>
                    </div>
                </div>
            </div>
