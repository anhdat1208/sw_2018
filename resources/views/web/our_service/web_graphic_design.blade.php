        ...
        <div class="section-full-vh bg-service-detail">
            <div class="container-fluid">
                <div class="detail-ctn">
                    <h2 class="title-detail">{{ __('web_graphic_design.title_detail') }}</h2>
                    <div class="detail-card">
                        <a class="btn-back" href=""><i class="lnr lnr-cross"></i></a>
                        <h3 class="text-heading">{{ __('web_graphic_design.heading') }}</h3>
                        <div class="text-lead">
                            <p>{{ __('web_graphic_design.text_lead') }}</p>
                        </div>
                        <div class="text-body">
                            <p>{!! __('web_graphic_design.content') !!}</p>
                        </div>
                    </div>
                </div>
            </div>
